...
import Main from './map/Lmap';
import ExplainPage from './pages/ExplainPage';
import EditLoisirPage from './pages/EditLoisirPage';
            ...
            <HashRouter>
                ...
                <main className="container pt-5">
                    <Switch>
                        ...
                        <PrivateRoute path="/editloisir" component={EditLoisirPage} />
                        <Route path="/Register" component={RegisterPage} />
                        <Route path="/explain" component={ExplainPage} />
